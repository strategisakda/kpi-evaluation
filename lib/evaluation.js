...
const EVAL_SELECT =
  'district, kpi_id, score, status, evidence_link, evidence_file_name, note, submitted_at, evaluated_at, evaluated_by, ai_consistency, ai_summary, ai_observations, ai_recommendations, ai_checked_at';
...
function mergeEvalWithKpi(district, kpiMaster, allRows) {

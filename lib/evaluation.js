...
const EVAL_SELECT =
  'district, kpi_id, score, status, evidence_link, evidence_file_name, evidence_file_path, note, submitted_at, evaluated_at, evaluated_by, ai_consistency, ai_summary, ai_observations, ai_recommendations, ai_achieved_level, ai_level_reasoning, ai_checked_at';
